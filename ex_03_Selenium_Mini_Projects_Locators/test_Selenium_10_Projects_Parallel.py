...
# pytest -n auto ex_03_Selenium_Mini_Projects_Locators/test_Selenium_10_Projects_Parallel.py --alluredir=allure_results
...
def test_project_2_katalon():
    ...
    since class has lead & text-danger, we shouldn't use both rather we should use only one like either lead|text-danger
    """
